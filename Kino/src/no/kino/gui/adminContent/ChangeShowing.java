...
public class ChangeShowing extends JDialog implements ActionListener {
    ...
    private ArrayList<Showing> createShowingsWithoutSales() {
        ...
        for (Showing m : showingsList) {
            for (Ticket t : ticketList) {
                ...
                if (!isFound) {
                    showingsListWithoutSales.add(counter, m);
                    counter++;
    ...
    private void changeShowing() throws ParseException {
        ...
        Date date = formatter.parse(dateText.getText());
    ...
    public JComboBox<Integer> getShowingNumberComboBox() {
        return showingNumberComboBox;
    }

    public void setShowingNumberComboBox(JComboBox<Integer> showingNumberComboBox) {
        this.showingNumberComboBox = showingNumberComboBox;
    }
}
